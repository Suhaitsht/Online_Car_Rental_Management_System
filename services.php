    ...
    <section class="ftco-section">
          ...
          <div class="col-md-7 text-center heading-section ftco-animate">
            ...
            <h2 class="mb-3">Our Latest Services</h2>
                ...
                <p>A fleet of luxury wedding cars in Sri Lanka, we are well geared for weddings and special occasions</p>
              </div>
            </div>
					</div>
					<div class="col-md-3">
            	...
            	<div class="icon d-flex align-items-center justify-content-center"><span class="flaticon-route"></span></div>
            	<div class="text w-100">
                <h3 class="heading mb-2">Self Drive Rental</h3>
                <p>A wide range of self drive cars in Sri Lanka from economical to luxury on daily, weekly and monthly terms</p>
              </div>
            </div>
					</div>
					<div class="col-md-3">
